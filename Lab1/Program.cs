class Program
{
    static void Main(string[] args)
    {
        ...
        while (!endApp)
        {
            ...
            Console.WriteLine("\tf - Factorial for 1st number");
            Console.WriteLine("\tt - Area of Triangle");
            Console.WriteLine("\tc - Area of Circle with radius for 1st number");
            Console.WriteLine("\tpe - Permutation");
            Console.WriteLine("\tco - Combination");
